...
import StarRating from "Containers/Tracks/components/StarRating";
...
class Inbox extends PureComponent {
  ...
  render() {
    const { tracks, currentId, totalTracks, inboxSort, actions } = this.props;
...
class TrackEditPane extends PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        <div
          className={`track-edit-pane ${
            this.state.isOpened ? "show-pane" : ""
          }`}
        >
...
function mapDispatch(dispatch) {
  return {
    actions: bindActionCreators(
      Object.assign({}, InboxActions, PlayerActions),
      dispatch
    )
  };
}
