defmodule SummerSinger.Web.TrackView do
  use SummerSinger.Web, :view

  def render("index.json", %{tracks: tracks, track_count: track_count}) do
    %{
      total: track_count,
      data: render_many(tracks, SummerSinger.Web.TrackView, "track.json")
    }
  end

  def render("show.json", %{track: track}) do
    %{data: render_one(track, SummerSinger.Web.TrackView, "track.json")}
  end
