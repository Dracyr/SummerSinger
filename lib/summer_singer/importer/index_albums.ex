defmodule SummerSinger.Importer.IndexAlbums do
  alias SummerSinger.{Repo, Folder, Track}
  require Logger

  defmodule SummerSinger.Importer.IndexAlbums.Folder do
  ...
  alias SummerSinger.Importer.IndexAlbums.Folder, as: IndexFolder
  ...
  def collect_updates(dir, folder_ids, parent_id) do
